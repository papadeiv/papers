...
function plot_imfs(timestep, timeseries, imfs)
        ...
        savefig("amoc/residuals/residuals_1.png", fig)
        ...
        for n in 1:(size(imfs,1)-1)
                ...
                # Export the figure
                savefig("amoc/residuals/residuals_$(n+1).png", fig)
        end
        ...
        savefig("amoc/residuals/modes.png", fig)
        ...
        savefig("amoc/residuals/detailed.png", fig)
end
