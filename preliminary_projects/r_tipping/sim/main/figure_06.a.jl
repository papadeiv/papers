...
G(t, n) = -n*((-(sinh(t))/(cosh(t)))^(n-1))/(cosh(t))^2
C = [-1.0, 0.0, -1.0, 0.0, -1.0, 0.0, 4.0, 0.0, 4.0, 0.0, -6.0]
...
include("../postprocessing/figure_06.a_postprocessing.jl")
include("../plotting/figure_06.a_plotting.jl")
