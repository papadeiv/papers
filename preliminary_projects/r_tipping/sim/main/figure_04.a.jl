...
# Export the data 
writeout(hcat(t, λ, x), "../data/figure_04/solution.csv")

# Execute the postprocessing and plotting scripts
include("../postprocessing/figure_04.a_postprocessing.jl")
include("../plotting/figure_04.a_plotting.jl")
