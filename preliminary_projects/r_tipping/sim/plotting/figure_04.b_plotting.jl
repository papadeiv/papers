...
lines!(ax, stable_eq_2[1:581,1], stable_eq_2[1:581,2], linewidth = 4, color = :black)
lines!(ax, unstable_eq[1:581,1], unstable_eq[1:581,2], linewidth = 4, color = (:black,0.35))
lines!(ax, stable_eq_2[582:end,1], stable_eq_2[582:end,2], linewidth = 4, color = :black)
lines!(ax, unstable_eq[582:end,1], unstable_eq[582:end,2], linewidth = 4, color = (:black,0.35))
