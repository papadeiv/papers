...
stable_eq_1 = readin("../data/figure_04/stable_eq_1.csv")
stable_eq_2 = readin("../data/figure_04/stable_eq_2.csv")
unstable_eq = readin("../data/figure_04/unstable_eq.csv")
...
lines!(ax, stable_eq_2[1:890,1], stable_eq_2[1:890,2], linewidth = 4, color = :black)
lines!(ax, unstable_eq[1:890,1], unstable_eq[1:890,2], linewidth = 4, color = (:black,0.35))
lines!(ax, stable_eq_2[891:end,1], stable_eq_2[891:end,2], linewidth = 4, color = :black)
lines!(ax, unstable_eq[891:end,1], unstable_eq[891:end,2], linewidth = 4, color = (:black,0.35))
