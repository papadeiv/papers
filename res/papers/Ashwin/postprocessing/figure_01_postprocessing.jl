...
# Export the data
writeout(hcat(t1, x1), "../data/figure_01/stable_eq_1.csv")
writeout(hcat(t2, x2), "../data/figure_01/stable_eq_2.csv")
writeout(hcat(t3, x3), "../data/figure_01/unstable_eq.csv")
