...
@showprogress for j in 1:NσI
        ...
        # Plot the figure 
        lines!(ax, domain_mT, VF, color = j, colormap = :viridis, colorrange = (1,NσI), linewidth = 2.5)
end

# Plot the colorbar
Colorbar(fig[1,2], limits = (domain_σI[1],domain_σI[end]), colormap = :viridis, label = L"\sigma_I", labelpadding = -60.0, labelsize = 50, ticks = [domain_σI[1],domain_σI[end]], ticksize = 22, ticklabelsize = 50, tickwidth = 5.0, spinewidth = 5.0, size = 36)

# Export the figure
save("../fig/fig1a.png", fig)
