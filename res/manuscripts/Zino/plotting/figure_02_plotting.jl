...
x3 = readin("../data/figure_02/x3.csv")
Nt = length(x3[:,1])

# Import the R-tipping statistics 
tip_cnt = convert(AbstractArray{Int64}, readin("../data/figure_02/tip_cnt.csv"))
tip_idx = convert(AbstractArray{Int64}, readin("../data/figure_02/tip_idx.csv"))
