...
stable_eq_1 = readin("../data/figure_02/stable_eq_1.csv")
stable_eq_2 = readin("../data/figure_02/stable_eq_2.csv")
unstable_eq = readin("../data/figure_02/unstable_eq.csv")
...
lines!(ax, stable_eq_2[1:527,1], stable_eq_2[1:527,2], linewidth = 4, color = :black)
lines!(ax, stable_eq_2[528:end,1], stable_eq_2[528:end,2], linewidth = 4, color = :black)
lines!(ax, unstable_eq[1:527,1], unstable_eq[1:527,2], linewidth = 4, color = (:black,0.35))
lines!(ax, unstable_eq[528:end,1], unstable_eq[528:end,2], linewidth = 4, color = (:black,0.35))
