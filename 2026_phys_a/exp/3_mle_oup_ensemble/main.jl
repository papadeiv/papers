...
function main(iteration::Integer)
        # Solve the ensemble problem
        ensemble = evolve(f, η, Λ, [a, α], stepsize=dt, steps=Nt, particles=Ne)
        ...
        writeout(solutions, "$iteration.csv")
...
for n in 1:N_exec
        # Execute the main
        printstyled("Iteration n.$n of $N_exec\n"; bold=true, underline=true, color=:light_blue)
        main(n)
