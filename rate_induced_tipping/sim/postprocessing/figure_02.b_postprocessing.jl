...
C = [-1.6, -2.0, 2.6, 2.0]
Λ(t) = C[1]*(tanh(t)) + C[2]*(tanh(t))^2 + C[3]*(tanh(t))^3 + C[4]*(tanh(t))^4
...
# Export the data
writeout(hcat(t1, x1), "../data/figure_02/stable_eq_1.csv")
writeout(hcat(t2, x2), "../data/figure_02/stable_eq_2.csv")
writeout(hcat(t3, x3), "../data/figure_02/unstable_eq.csv")
